...
**This is the only instruction file for this repo.** `CLAUDE.md` is a one-line `@AGENTS.md` import and holds no content. Never copy this file into a tool-specific file, never rename it, and never find-replace tool names inside it. New instructions go here.
